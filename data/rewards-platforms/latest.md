...
Generated: 2026-08-05T04:20:38+00:00
...
| 2 | Kalshi | Liquidity Incentive Program | 67 | prediction_market | medium | high | monitor_and_approval_ticket | Eligible members post qualifying resting limit orders. Random snapshots score order size, uptime, and proximity to the best bid/ask; pools are split pro rata. |
...
| 4 | Polymarket | Maker Rebates | 67 | prediction_market | medium | high | monitor_and_paper_score | Place maker orders that add liquidity and later fill on markets with fees enabled. |
...
| 9 | Polymarket | Taker Rebates | 49 | prediction_market | high | high | monitor_and_manual_review | Generate eligible weighted taker volume by category and tier while avoiding abusive or wash activity. |
| 10 | Polymarket US | Liquidity Incentive Program | 49 | prediction_market | high | high | monitor_and_approval_ticket | Place resting orders close to the best price. Random order-book snapshots score size by tick distance and target-size eligibility. |
| 11 | Aave | Liquidity Incentives, Safety Module, and Merit | 42 | defi_protocol | medium | high | watchlist_only | Supply, borrow, stake, or perform Aave-aligned actions eligible for DAO or external incentives. |
| 12 | Aerodrome | LP Emissions and veAERO Incentives | 42 | defi_protocol | medium | high | watchlist_only | Provide liquidity to pools, or lock/vote veAERO to direct emissions and receive pool fees/incentives. |
